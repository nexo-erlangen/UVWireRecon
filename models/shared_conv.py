def create_shared_dcnn_network():
    ...
    shared_pooling_1_U = MaxPooling2D(pool_size=(4, 2), name='Shared_2_U')
    shared_conv_2_U = Conv2D(32, kernel_size=(5, 3), activation='relu', name='Shared_3_U')
    shared_pooling_2_U = MaxPooling2D(pool_size=(4, 2), name='Shared_4_U')
    ...
    shared_pooling_1_V = MaxPooling2D(pool_size=(4, 2), name='Shared_2_V')
    shared_conv_2_V = Conv2D(32, kernel_size=(5, 3), activation='relu', name='Shared_3_V')
    shared_pooling_2_V = MaxPooling2D(pool_size=(4, 2), name='Shared_4_V')
    ...
    merge_TPC_1 = concatenate([pooled_3_U_1, pooled_3_V_1], name='TPC_1')
    merge_TPC_2 = concatenate([pooled_3_U_2, pooled_3_V_2], name='TPC_2')
    ...
    # Merge Dense Layers
    merge_TPC_1_2 = concatenate([dense_2_TPC_1, dense_2_TPC_2])

    # Output of U- and V-wire
    # output_TPC_1 = shared_output(dense_2_TPC_1)
    # output_TPC_2 = shared_output(dense_2_TPC_2)
    output_TPC_1_2 = Dense(4, activation='relu', name='Output_TPC_1_and_2')(merge_TPC_1_2)

    return Model(inputs=[visible_U_1, visible_V_1, visible_U_2, visible_V_2], outputs=[output_TPC_1_2])
